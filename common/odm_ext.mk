...
$(INSTALLED_FILES_FILE_ODM_EXT): $(shell find $(CHIP_DIR)/files/tv/tvconfig -type f)
$(INSTALLED_FILES_FILE_ODM_EXT) : $(INTERNAL_ODM_EXTIMAGE_FILES) $(FILESLIST) $(FILESLIST_UTIL) $(PQ_FILES)
